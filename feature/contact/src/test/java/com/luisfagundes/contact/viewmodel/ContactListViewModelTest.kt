package com.luisfagundes.contact.viewmodel

import androidx.arch.core.executor.testing.InstantTaskExecutorRule
import androidx.lifecycle.Observer
import com.luisfagundes.common.Result
import com.luisfagundes.contact.ContactListUiState
import com.luisfagundes.contact.ContactListViewModel
import com.luisfagundes.contact.model.fakeUserList
...
class ContactListViewModelTest {
    ...
    fun `getUsers should update uiState with Error when repository returns Error`() {
        val exception = java.lang.Exception("Error fetching users")
